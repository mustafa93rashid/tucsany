    ...
    return (
        <div className='max-w-[1800px] mx-auto'>
            <div  className="px-[4.1025641%] lg:px-[5.55555556%] xl:px-[13.0208333%] flex-col lg:flex-row flex items-center justify-between gap-8 pt-[120px] ">
                <Image data-aos="zoom-in-right" src={data.image} alt={data.title} width={450} height={650} className={`${className}`}
                />
                <div data-aos="zoom-in-left" className='flex flex-col items-center lg:items-start gap-8 w-full lg:w-[550px]  2xl:max-w-[700px]'>
