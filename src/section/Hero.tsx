    ...
    <div className='relative'>
      ...
      {showContent ? (
        <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white text-center space-y-4 mt-6 sm:mt-0' >
          <h2 data-aos="fade-up"  className={`text-center text-xl md:text-5xl lg:text-7xl ${podcast.variable}`} style={{ fontFamily: 'var(--font-podcast)' }}
        ...
        <div data-aos="fade-up" className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white text-center space-y-4 mt-6 sm:mt-0'>
          <h2  className={`text-center text-3xl md:text-5xl lg:text-7xl ${podcast.variable}`} style={{ fontFamily: 'var(--font-podcast)' }}>Our team cares about your full relax</h2>
